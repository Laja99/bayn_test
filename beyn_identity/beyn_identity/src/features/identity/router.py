...
from src.features.identity import service
from src.core.i18n import get_locale
from src.features.identity.dependencies import get_current_active_user
from src.features.identity.models import User
...
async def get_me(
    ...
    from src.features.identity.service import _build_user_response
